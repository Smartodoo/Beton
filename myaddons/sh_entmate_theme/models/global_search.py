...
class GlobalSearchFields(models.Model):
    ...
    _description = "Global Search field"
    ...
    def sh_o2m_dynamic_action_action(self):
        if self.ttype == 'one2many':
            view = self.env.ref('sh_entmate_theme.sh_o2m_global_search_form')
            return {
            ...
            view = self.env.ref('sh_entmate_theme.sh_m2o_global_search_form')
            return {
...
class O2MGlobalSearch(models.Model):
    ...
    field_id = fields.Many2one('ir.model.fields', string='Position Field')
